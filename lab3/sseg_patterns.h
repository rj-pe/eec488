...
// "--HI----" -- initial state
const uint8_t HI_PTN[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xF9, 0x78, 0xFF, 0xFF};
// "--SL----" -- slow state
const uint8_t SL_PTN[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xC7, 0x12, 0xFF, 0xFF};
// "--CH----" -- cheat state
const uint8_t CH_PTN[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0x09, 0xB9, 0xFF, 0xFF};
// "0000----" -- (wait state) and (turn on & wait states)
const uint8_t ZERO_PTN[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0x40, 0x40, 0x40, 0x40};
